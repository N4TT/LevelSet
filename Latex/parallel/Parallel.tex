...
\lstinputlisting[caption={Simple CUDA program}, label={CUDAex}, numbers=left, belowcaptionskip=4pt]{parallel/CUDAexampleCode.c} %inputs the source code with numbered lines
