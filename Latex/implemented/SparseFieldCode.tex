...
The speed function is implemented in a seperate methods that takes in the coordinates of the pixel to calculate the speed chnage and returns this value which thwn is added to thr previous value. Two speed functions are implemented, the one explained in chapter \label{GHJHGHGHJGFDJHFGDJHFGJDHGFJHF} and a much more simple one.
