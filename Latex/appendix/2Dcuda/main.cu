...
#include <cuda.h>
#include "main.h"
#include "update.h" //levelset evolvement happens here
...
int main(int argc, char *argv[]){	printf("1");
	...
	writeFile(img, 1, iterations); //store label as image
	writeFile(img, 2, iterations); //store zerolevel set as image
